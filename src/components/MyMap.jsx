...
import yosemiteData from '../data/regions/yosemite.json';
...
export const MyMap = () => {
  ...
  const [showYosemite, setShowYosemite] = useState(true);
  return (
    <div className={style.wrapper}>
      ...
      >
        ...
        <MapControls
          ...
          showYosemite={showYosemite}
          setShowYosemite={setShowYosemite}
        />
        <LocationMarker />
        {showYosemite && <GeoJSON data={yosemiteData} />}
        {showCamps && <Camps />}
        {showTracks && <Tracks />}        
      </MapContainer>
    </div>
